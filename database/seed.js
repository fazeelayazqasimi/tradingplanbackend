...
const seed = async () => {
  try {
    ...
    const defaultSettings = [
      ...
      { key: 'free_registration_bonus_enabled', value: true, category: 'general', description: 'Enable the registration referral bonus for the direct upline' },
      { key: 'free_registration_bonus_amount', value: 1, category: 'general', description: 'Amount credited to the direct upline funding wallet per free registration' },
