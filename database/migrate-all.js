...
async function migrate() {
  try {
    ...
    // ===== 1. RANKS: Rename D1-D6 → V1-V6 with commission values =====
    console.log('--- Step 1: Ranks ---');
    const rankConfig = [
      { order: 1, name: 'V1', slug: 'v1', activationGain: 30, quantification: 5, indirectIncome: 5 },
      { order: 2, name: 'V2', slug: 'v2', activationGain: 40, quantification: 6, indirectIncome: 8 },
      { order: 3, name: 'V3', slug: 'v3', activationGain: 50, quantification: 7, indirectIncome: 10 },
      { order: 4, name: 'V4', slug: 'v4', activationGain: 60, quantification: 8, indirectIncome: 12 },
      { order: 5, name: 'V5', slug: 'v5', activationGain: 65, quantification: 9, indirectIncome: 15 },
      { order: 6, name: 'V6', slug: 'v6', activationGain: 70, quantification: 10, indirectIncome: 20 },
    ];
