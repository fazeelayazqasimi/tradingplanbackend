...
const { createDeposit, getMyDeposits, getAllDeposits, approveDeposit, rejectDeposit, deleteDeposit, getSupportedCoins, verifyCryptoPayment } = require('../controllers/depositController');
